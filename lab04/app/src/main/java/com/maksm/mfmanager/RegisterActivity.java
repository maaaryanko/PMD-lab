...
public class RegisterActivity extends AppCompatActivity implements ChoosingSecurityQuestionFragment.FromCallBack{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m.DataBase = FirebaseDatabase.getInstance().getReference(USER_KEY);
    ...
    public void onClickCreate(View view)
    {
        ...
        String security_answer = securityATv.getText().toString();
        User newUser = new User(id, email, password, security_answer);
        if(!TextUtils.isEmpty(email) && !TextUtils.isEmpty(password) && !TextUtils.isEmpty(security_answer))
        {
